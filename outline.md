...
- 1.1 Machine Learning: what and why?
  - 1.1.1 Types of machine learningp2
    - figure 1.1 some labeled training examples; N x D design matrix p3
- 1.2 Supervised learning 3
  - 1.2.1 Classification p3
    - figure 1.3 Iris flower dataset p6
    - figure 1.4 Visualization of the Iris data set as a pairwise scatter plot p6
    - figure 1.5 (a) first 9 test MNIST gray-scale images p7
    - figure 1.6 Example of face detection p8
  - 1.2.2 Regression p8
    - figure 1.7 (a) Linear regression on some ld data (b) same data with polynomial regression p9
- 1.3 Unsupervised learning p9
    - figure 1.8 The height and weight of some people p10
  - 1.3.1 Discovering clusters p10
  - 1.3.2 Discovering latent factors p11
    - figure 1.11 A sparse undirected Gaussian graphical model learned using graphical lasso p13
  - 1.3.3 Discovering graph structure p13
    - figure 1.14 K-nearest neighbors classifier in 2D
...
1.4 Some basic concepts in machine learning p16
  ...
  - 1.4.3 The curse of dimensionality p18
     - figure 1.16 Illustration of the curse of dimensionality p18
     - figure 1.17 (a) A Guassian pdf with mean 0 and variance 1 (b) Visualization of the conditional density model p19
  - 1.4.4 Parametric models for classification and regression p19
  - 1.4.5 Linear regression p19
    - figure 1.18 Polynomials of degree 14 and 20 fit by least squares to 21 data points. Figure generated by linregPolyVsDegree p20
    - figure 1.19 (a) The sigmoid or logistic function (b) Logistic regression for SAT scores p21
  - 1.4.6 Logistic regression p21
  - 1.4.7 Overfitting p22
  - 1.4.8 Model selection p22
    - figure 1.20 Prediction surface for KNN on the data in Figure 1.15(a) (a) K=1 (b) K=5. Figure generated by knnClassifyDemo p23
    - figure 1.21 (a) Misclassification rate vs K in a k-nearest neighbor classifier p24
  - 1.4.9 No free lunch theorem p24
...
- 2.3 Some common continuous distributions p34
  - 2.3.1 The binomial and Bernoulli distributions p34
    - Figure 2.4 Illustation of the binomial distribution with n = 10 p35
    - Figure 2.5 (a) Some aligned DNA sequences (b) The corresponding sequence logo. The vertical axis represents 2 - H where H is the entropy of the distribution for that column (measured in bits). Thus deterministic distributions (with an entropy of 0) have height 2, and uniform distributions (with an entropy of 2) have height 0 p36
  - 2.3.2 The multinomial and multinoulli distributions p35
    - figure 2.6 Illustration of some Poisson distributions p37
...
- 2.6 Transformation of random variables p49
  ...
  - 2.6.3 Central limit theorem p52
    - figure 2.17 The central limit theorem in pictures p52
- 2.7 Monte Carlo approximation p53
  - 2.7.1 Example: change of variables, the MC way p53
    - figure 2.18 computing the distribution of y = x^2
  - 2.7.2 Example pi by Monte Carlo integration p54
    - figure 2.19 estimating pi by Monte Carlo integration p55
  - 2.7.3 Accuracy of Monte Carlo approximation p54
    - figure 2.20 10 and 100 samples from a Gaussian distribution p55
